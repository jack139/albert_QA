...
from models.bert_google_modeling import BertModelMRC, BertConfig
...
if __name__ == '__main__':
    ...
    parser.add_argument('--vocab_file', type=str, default='../nlp_model/chinese_bert_L-12_H-768_A-12/vocab.txt')
    parser.add_argument('--bert_config_file', type=str, default='../nlp_model/chinese_bert_L-12_H-768_A-12/bert_config.json')
    parser.add_argument('--init_restore_dir', type=str, default='../nlp_model/chinese_bert_L-12_H-768_A-12/bert_model.ckpt')
    parser.add_argument('--checkpoint_dir', type=str, default='outputs/cmrc2018/chinese_bert_L-12_H-768_A-12/')
