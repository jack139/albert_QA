...
if __name__ == '__main__':
    ...
    # data dir
    parser.add_argument('--vocab_file', type=str, default='../nlp_model/albert_tiny_489k/vocab.txt')
    ...
    parser.add_argument('--bert_config_file', type=str,
                        default='../nlp_model/albert_tiny_489k/albert_config_tiny.json')
    parser.add_argument('--init_restore_dir', type=str,
                        default='../nlp_model/albert_tiny_489k/albert_model.ckpt')
    parser.add_argument('--checkpoint_dir', type=str,
                        default='outputs/cmrc2018/albert_tiny_489k/')
